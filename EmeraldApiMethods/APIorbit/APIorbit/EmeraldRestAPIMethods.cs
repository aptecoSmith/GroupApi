...
namespace GroupApi
{
    public class EmeraldRestAPIMethods
    {
        ...
        public string appFolder = @"C:\temp\OrbitTests";
        public string jsonFolder = @"C:\temp\OrbitJsons";
        ...
        public IRestResponse<EmeraldsDashboards.Root> dashboardListResponse;
        ...
        public IRestResponse<EmeraldsCollections.Root> collectionListResponse;
        ...
        public IRestResponse<EmeraldsCompositions.Root> compositionListResponse;
        ...
        public IRestResponse<EmeraldsCampaigns.Root> campaignListResponse;
        ...
        public IRestResponse dataPosted;
        ...
        public void GetDashboards(string count = "100")
        {
            ...
            dashboardListResponse = client.Execute<EmeraldsDashboards.Root>(request);
            dashboardTitles = new List<string>();

            foreach (var item in dashboardListResponse.Data.list)
        ...
        public void GetCollections(string count = "50")
        {
            ...
            collectionListResponse = client.Execute<EmeraldsCollections.Root>(request);

            collectionTitles = new List<string>();

            foreach (var item in collectionListResponse.Data.list)
            {
                var title = item.title;
        ...
        public void GetCompositions(string count = "100")
        {
            ...
            compositionListResponse = client.Execute<EmeraldsCompositions.Root>(request);

            compositionDescriptions = new List<string>();

            foreach (var item in compositionListResponse.Data.list)
            {
        ...
        public void GetCampaigns(string count = "100")
        {
            ...
            campaignListResponse = client.Execute<EmeraldsCampaigns.Root>(request);

            campaignDescriptions = new List<string>();

            foreach (var item in campaignListResponse.Data.list)
        ...
        {
            string filelocation = @"C:\temp\OrbitJsons\audience.json";
        ...
        {
            string audienceJson = File.ReadAllText(string.Join(@"\", jsonFolder,"audience.json"));
        ...
        public string PostToAudience(string json)
        {
            ...
            dataPosted = client.Execute(request);

            string apiResultUrl = dataPosted.Headers[2].Value.ToString();
        ...
        public string PickDashboard(IRestResponse<EmeraldsDashboards.Root> responseDashboard, string dashboardInput)
        {
            string gotId = "";
            string gotTitle = "";
            int userGaveAnInt = 0;
        ...
        public void DashJsonSave(string dashboardDefinition)
        {
            string filelocation = string.Join(@"\", jsonFolder, "dashboard.json");
        ...
        {
            string dashboardJson = File.ReadAllText(string.Join(@"\", jsonFolder, "dashboard.json"));
        ...
        {
            string result = File.ReadAllText(string.Join(@"\", jsonFolder, "dashboard.json"));
        ...
        public string PostToDashboard(string json)
        {
           ...
           dataPosted = client.Execute<DashboardDetails.Root>(request);
        ...
        public string PickCollection(IRestResponse<EmeraldsCollections.Root> collectionListResponse, string collectionInput)
        { 
            string gotId = "";
            string gotTitle = "";
            int userGaveAnInt = 0;
        ...
        public void CollJsonSave(string collectionDefinition)
        {
            string filelocation = string.Join(@"\", jsonFolder, "collection.json");
        ...
        {
            string collectionJson = File.ReadAllText(string.Join(@"\", jsonFolder, "collection.json"));
        ...
        public string PickComposition(IRestResponse<EmeraldsCompositions.Root> compositionListResponse, string compositionInput)
        {
        ...
        public void CompJsonSave(string audienceDefinition)
        {
            string filelocation = string.Join(@"\", jsonFolder, "composition.json");
        ...
        {
            string compositionJson = File.ReadAllText(string.Join(@"\", jsonFolder, "composition.json"));
        ...
        public string PickCampaign(IRestResponse<EmeraldsCampaigns.Root> campaignListResponse, string campaignInput)
        {
            ...
            // Handle input
            bool isUserInputAID = campaignInput.Contains(" ");
            if (isUserInputAID == false)
            {
                // If user has input a number, try to match with an ID from a row in the list
                // If the number is a hit as an ID proceed to get the definition from the ID
        ...
        public void CampJsonSave(string campaignDefinition)
        {
            string filelocation = string.Join(@"\", jsonFolder, "campaign.json");
        ...
        {
            string campaignJson = File.ReadAllText(string.Join(@"\", jsonFolder, "campaign.json"));
